...
CREATE SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_784E57F6_2DE3_4521_A024_B835FA35D4E1" START WITH 1 BELONGS_TO_TABLE;
...
CREATE CACHED TABLE "PUBLIC"."LEARNING_PATH"(
...
CREATE CACHED TABLE "PUBLIC"."COURSE_LEARNING_PATH"(
...
CREATE CACHED TABLE "PUBLIC"."COURSE_USER_SNAPSHOT"(
    "USER_LOGIN" VARCHAR(255) NOT NULL,
    "COURSE_ID" BIGINT NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."LEARNING_PATH_USER"(
    "USER_LOGIN" VARCHAR(255) NOT NULL,
    "LEARNING_PATH_ID" BIGINT NOT NULL
);
